...
Form of Output:
	...
	for each ingredient.
"""
def get_cuisine_prob_given_ingredient(data, all_cuisines, all_ingredients):
	cuisine_prob_given_ingredient = {ingredient : {cuisine : 0.001 for cuisine in all_cuisines} for ingredient in all_ingredients}
	#cuisine_prob_given_ingredient = {}
	...
	for recipe in data:
		...
		ingredients = recipe['ingredients']
		for ingredient in ingredients:
			cuisine_prob_given_ingredient[ingredient][cuisine] += 1
...
def test_classifier(train_file):
	...
	cuisine_prob_given_ingredient = get_cuisine_prob_given_ingredient(train_data, [cuisine for cuisine in cuisine_probs], [ingredient for ingredient in ingredient_probs])
